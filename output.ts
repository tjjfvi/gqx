...
const _$Author = <T extends $Hkt>(f: (x: $Fragment) => any): _$Author<T> => ({
  ...
  get books() {
    return _$Book<$Compose<T, $WrapHkt<"Author$books">>>(x =>
      $Fragment._create("Author$books", f(x))
    )
  },
  get id() {
    return f($Fragment._create("Author$id", null))
  },
  get name() {
    return f($Fragment._create("Author$name", null))
  },
})
...
// @ts-ignore
export type Author<F extends Author.$ | Author.$[]> = F extends Author.$<infer X> ? X
  : $ExpandDeep<
    { [K in keyof F]: (x: Author<F[K]>) => void }[number] extends (x: infer X) => void ? X : never
  >
...
const _$Book = <T extends $Hkt>(f: (x: $Fragment) => any): _$Book<T> => ({
  $: ((...a: $Fragment[]) => f($Fragment.merge(...a))) as any,
  get author() {
    return _$Author<$Compose<T, $WrapHkt<"Book$author">>>(x =>
      $Fragment._create("Book$author", f(x))
    )
  },
  get description() {
    return f($Fragment._create("Book$description", null))
  },
  get id() {
    return f($Fragment._create("Book$id", null))
  },
  get title() {
    return f($Fragment._create("Book$title", null))
  },
})
...
// @ts-ignore
export type Book<F extends Book.$ | Book.$[]> = F extends Book.$<infer X> ? X
  : $ExpandDeep<
    { [K in keyof F]: (x: Book<F[K]>) => void }[number] extends (x: infer X) => void ? X : never
  >
...
const _$Person = <T extends $Hkt>(f: (x: $Fragment) => any): _$Person<T> => ({
  $: ((...a: $Fragment[]) => f($Fragment.merge(...a))) as any,
  get id() {
    return f($Fragment._create("Person$id", null))
  },
  get name() {
    return f($Fragment._create("Person$name", null))
  },
})
...
// @ts-ignore
export type Person<F extends Person.$ | Person.$[]> = F extends Person.$<infer X> ? X
  : $ExpandDeep<
    { [K in keyof F]: (x: Person<F[K]>) => void }[number] extends (x: infer X) => void ? X : never
  >
...
const _$Query = <T extends $Hkt>(f: (x: $Fragment) => any): _$Query<T> => ({
  $: ((...a: $Fragment[]) => f($Fragment.merge(...a))) as any,
  get getBook() {
    return _$Book<$Compose<T, $WrapHkt<"Query$getBook">>>(x =>
      $Fragment._create("Query$getBook", f(x))
    )
  },
  get getPeople() {
    return _$Person<$Compose<T, $WrapHkt<"Query$getPeople">>>(x =>
      $Fragment._create("Query$getPeople", f(x))
    )
  },
})
...
// @ts-ignore
export type Query<F extends Query.$ | Query.$[]> = F extends Query.$<infer X> ? X
  : $ExpandDeep<
    { [K in keyof F]: (x: Query<F[K]>) => void }[number] extends (x: infer X) => void ? X : never
  >
...
const _$User = <T extends $Hkt>(f: (x: $Fragment) => any): _$User<T> => ({
  $: ((...a: $Fragment[]) => f($Fragment.merge(...a))) as any,
  get id() {
    return f($Fragment._create("User$id", null))
  },
  get name() {
    return f($Fragment._create("User$name", null))
  },
  get username() {
    return f($Fragment._create("User$username", null))
  },
})
...
// @ts-ignore
export type User<F extends User.$ | User.$[]> = F extends User.$<infer X> ? X
  : $ExpandDeep<
    { [K in keyof F]: (x: User<F[K]>) => void }[number] extends (x: infer X) => void ? X : never
  >
...
export const $gqx = <F extends $Hkt<$OperationProps>>(
  f: <P extends $OperationProps>(p: P) => $CallHkt<F, P>,
) => ({
  query: {
