...
import { $OperationProps, $Hkt, $Frag, $Output, $DeepPropTypes, $gqx, Book, $Input } from "./output";

// Type of e.g. gqx.query.getBook
type GqxOut_<I extends $OperationProps> =
  <F extends $Frag[$DeepPropTypes[I]]>(input: $Input[I], frag: F)
